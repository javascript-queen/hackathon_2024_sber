...
Выбор, построение архитектуры, разработка алгоритма, написание кода, оптимизация модели:
- Анна Трэйлор		
- Сергей Сарапулов					
- Мария Земскова
  
Первичный анализ, сбор дополнительных данных, визуализация результатов, проверка работоспособности кода:  				
- Абабнех Иосиф
- Черкесов Константин
- Вагиз Якупов
